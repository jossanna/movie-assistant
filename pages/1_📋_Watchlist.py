...
username = st.sidebar.text_input("Letterboxd Username", value="ossanna")
...
if username:
    ...
    with st.spinner("Loading your watchlist..."):
        ...
        for tmdb_id, title in zip(
            watchlist_letterboxd_data_df["tmdb_id"],
            watchlist_letterboxd_data_df["title"],
        ):
        ...
        st.dataframe(
            ...
            column_config={
                ...
                "offers": st.column_config.ListColumn("Streaming Services"),
    ...
    st.info(
        "Please enter your Letterboxd username in the sidebar to view your watchlist."
    )
